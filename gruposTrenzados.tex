...
\centering
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{center}
		\begin{tikzpicture}
		\braid[line width =1.5pt, number of strands = 3, name = b1] (b1) at (-3,3) a_1^{-1} a_1;
	\node[] at (-3.75,1.75){$\beta_1$};
	\node[] at (0,0){};
		\braid[line width =1.5pt, height = 15pt, nudge factor = 0.01, control factor = 0.5, name = b2] (b2) at (-3,0) a_1^{-1} a_2 a_1^{-1} a_2^{-1};
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{center}
		\begin{tikzpicture}
		\braid[line width =1.5pt, height = 20pt, number of strands = 3]  a_1^{-1} a_1 a_1^{-1} a_2 a_1^{-1} a_2^{-1};
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{center}
		\begin{tikzpicture}
		\braid[line width =1.5pt, number of strands = 3, name = a] (a) at (-2,0) a_1^{-1} a_1;
	\node[right = 1cm of a] (b){$\times$};
\node[right = 1cm of b] (c){};
		\braid[line width =1.5pt, number of strands = 3, name = c]  a_1^{-1} a_1;
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.45\linewidth}
		\begin{center}
		\begin{tikzpicture}
		\braid[line width =1.5pt, height = 15pt, nudge factor = 0.01, control factor = 0.5]  a_1^{-1} a_2 a_1^{-1} a_2^{-1} a_2 a_2 a_2 a_1 a_2;
		\end{tikzpicture}
		\caption{}
		\end{center}
	\end{subfigure}
		\caption{hola me llamo fernandao}
\end{figure}
\end{ejem}
