...
\label{sec:grupos}
En este capítulo vamos a repasar algunos aspectos de la teoría de grupos que en su mayoría se han visto a lo largo de la carrera. Estos aparecen en \cite{group, br_gr, wiki, alg_abs}, y serán necesarios para desarrollar tanto el grupo de trenzas, como la parte de criptografía y criptoanálisis. En primer lugar vamos a comenzar con algunos conceptos básicos sobre grupos.
...
Una definición equivalente de monoide libre es la siguiente. Dado un conjunto $X$ no vacío, el conjunto de palabras en $X$, tomando las definiciones de palabras vistas en la Sección \ref{sec:grupo_libre}, junto con la operación de yuxtaposición es un monoide libre en $X$. La demostración se puede ver en \cite{monoides}.
